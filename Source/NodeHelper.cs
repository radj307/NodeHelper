    ...
    public class NodeHelperAddon : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            if (_stockToolbar && btnLauncher == null)
                btnLauncher = ApplicationLauncher.Instance.AddModApplication(() => _show = !_show, () => _show = !_show, null, null, null, null, ApplicationLauncher.AppScenes.VAB | ApplicationLauncher.AppScenes.SPH, GameDatabase.Instance.GetTexture("NodeHelper/Textures/NodeHelper", false));
            ...
            _nodeHelperButton.TexturePath = "NodeHelper/Textures/NodeHelper";
